...
@section('page_title', 'Créer un paiement')
@section('content')
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Montant (<del style="text-decoration-style: double">N</del>) <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
    ...
    {{--Fin de la création de paiement--}}
